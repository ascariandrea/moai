...
public abstract class EndlessScrollListener<T extends Model> implements AbsListView.OnScrollListener {
    ...
    // Save last item loaded.
    private T lastItemLoaded;

    public EndlessScrollListener(List<T> itemsList) {
        this.itemsList = itemsList;
        if (itemsList.size() > 0)
            this.lastItemLoaded = itemsList.get(itemsList.size() - 1);
    }
    ...
    public void setLastItemLoaded(T item) {
